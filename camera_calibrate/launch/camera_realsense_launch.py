...
local_parameters = [{'name': 'camera_name1',            'default': 'camera_wrist', 'description': 'camera unique name'},
                    {'name': 'camera_name2',            'default': 'camera_scene1', 'description': 'camera unique name'},
                    {'name': 'camera_name3',            'default': 'camera_scene2', 'description': 'camera unique name'},
                    {'name': 'camera_namespace1',       'default': 'camera', 'description': 'camera1 namespace'},
                    {'name': 'camera_namespace2',       'default': 'camera', 'description': 'camera2 namespace'},
                    {'name': 'camera_namespace3',       'default': 'camera', 'description': 'camera3 namespace'},
