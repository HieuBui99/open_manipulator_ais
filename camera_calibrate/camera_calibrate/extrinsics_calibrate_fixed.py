...
class ExtrinsicsEstimator:
    def __init__(self, square_size_mm, chessboard_size=(8, 5), intrinsics_file='intrinsics_cam_scene2.npz'):
...
class KeyboardController(Node):
    def __init__(self, stop_event: threading.Event, 
                 topic_name="/camera/camera_scene1/color/image_raw", 
                 fps=None, 
                 node_name=None, 
                 msg_type=Image,
                 square_size_mm=28.0,
...
def main():
    rclpy.init()
    node = KeyboardController(stop_event=threading.Event(), chessboard_size=(8, 5), square_size_mm=30.0)
